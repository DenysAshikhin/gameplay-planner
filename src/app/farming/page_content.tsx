...
const FarmingLanding = () => {
    ...
    const [bestPlantCombo, setBestPlantCombo] = useState([] as any);//holds the best production, total made, pic and pic% after a calculation
    // const [bestRunningCombo, setBestRunningCombo] = useState({});//same as above, but used to make the graph update during the loading
    const bestRunningCombo: any = useMemo(() => {
        return {}
    ...
    let tooManyAuto: number | boolean = 0;
                                        ...
                                        <div style={{ display: 'flex', marginTop: '6px' }}>
                                            ...
                                            <input type="checkbox" checked={timeStepMode}
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    setTimeStepMode((e.target.checked ? 1 : 0) as any);
                                                    ReactGA.event({
                                                        category: "farming_interaction",
                            ...
                            >
                                ...
                                >
                                    <div style={{ display: 'flex' }}>
                                        ...
                                        <input type="checkbox" checked={showFries}
                                            ...
                                            onChange={(e) => {
                                                setShowFries((e.target.checked ? 1 : 0) as any);
                                                ReactGA.event({
                                                    category: "farming_interaction",
                                    ...
                                    <div style={{ display: 'flex', marginBottom: '' }}>
                                        ...
                                        <input type="checkbox" checked={showHP}
                                            ...
                                            onChange={(e) => {
                                                setShowHP((e.target.checked ? 1 : 0) as any);
                                                ReactGA.event({
                                                    category: "farming_interaction",
                                ...
                                <div style={{ display: 'flex' }}>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            setAutoBuyPBC((e.target.checked ? 1 : 0) as any);
                                            ReactGA.event({
                                                category: "farming_interaction",
                                ...
                                <div style={{ display: 'flex' }}>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            setLockCustomAuto((e.target.checked ? 1 : 0) as any);
                                            ReactGA.event({
                                                category: "farming_interaction",
                                ...
                                <div style={{ display: 'flex' }}>
                                    ...
                                    <input
                                        ...
                                        type="checkbox"
                                        onChange={(e) => {
                                            setForceRankPotion((e.target.checked ? 1 : 0) as any);
                                            ReactGA.event({
                                                category: "farming_interaction",
                                    ...
                                    <div className='calcResult' style={{ width: `calc(200px + ${tempFuture.plants.length * 115}px)`, maxWidth: 'calc(100% - 6px)' }}>
                                        <>
                                            ...
                                            <div style={{ display: 'flex' }}>
                                                ...
                                                {/* 2026-01-01 Icy: doesn't seem like this is used at all anymore? */}
                                                {bestPlantCombo.bestPot.result.result.steps.map((val, index) => {
                                                    return (
                                                        ...
                                                        <div className='suggestionHolder' key={index} style={{ borderRight: index !== (bestPlantCombo.bestPot.result.result.steps.length - 1) ? '1px solid rgba(0, 119, 255, 0.563)' : '' }}>
                                                            ...
                                                            <MouseOverPopover style={{ 'marginTop': 'auto' }} key={'popover' + index} tooltip={
                                                                "Show how many PIC levels are gained (if any) and the time to hit the NEXT pic with your MAX num autos used"
                                                    ...
                                                    {bestPlantCombo.bestPic.result.result.steps.map((val, index) => {
                                                        ...
                                                        return (
                                                            <div className='suggestionHolder' key={index} style={{ borderRight: index !== (bestPlantCombo.bestPot.result.result.steps.length - 1) ? '1px solid rgba(0, 119, 255, 0.563)' : '' }}>
                                                                ...
                                                                <MouseOverPopover style={{ 'marginTop': 'auto' }} key={'popover' + index} tooltip={'Show how many PIC levels are gained (if any) and the time to hit the NEXT pic with your MAX num autos used'
                                                                }>
                                                                    <div className='futurePicHolder'>
                                                                        {`${helper.secondsToString(farmingHelper.calcTimeTillPrestige(
