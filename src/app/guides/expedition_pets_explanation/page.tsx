...
export async function generateMetadata({ params, searchParams }, parent) {
  ...
  return buildMetadata({
    title: "Expeditions Pets Explanation",
    description:
      "Farmer Against Potatoes Idle (FAPI) expeditions pets explanation: how expedition pets work, how to interpret bonuses, and how to use the expeditions calculator effectively.",
    path: "/guides/expedition_pets_explanation",
  });
}
