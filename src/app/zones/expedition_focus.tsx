...
import Priority_list from './priority_list';
...
export default function Zones({
    ...
    let teams = useMemo(() => {
        ...
        data.PetsExpeditionLoadout.forEach((cur_team, index) => {
            if (index === 0 || cur_team.Locked === 0) return;
            let inner_team: any = [];
    ...
    useEffect(() => {
        ...
        let hp_goal: DecimalSource = 1;
        let hp_goal_difference: DecimalSource = -1;
        let zone_to_work: any = { data: null, index: -1 };

        let earliest_locked_zone: any = { data: null, index: 99 };
