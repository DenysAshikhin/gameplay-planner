        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            if (!isGenerate) {
                if (isCompile && useBuildWorker) {
                    ...
                    await (0, _webpackbuild.webpackBuild)(true, [
                        "server"
                    ]).then((res)=>{
                    ...
                    const { duration: webpackBuildDuration, ...rest } = turboNextBuild ? await turbopackBuild() : await (0, _webpackbuild.webpackBuild)(false);
