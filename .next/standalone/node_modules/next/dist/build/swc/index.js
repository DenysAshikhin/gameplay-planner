...
const getSupportedArchTriples = ()=>{
    const { darwin, win32, linux } = _triples.platformArchTriples;
    return {
        darwin,
        win32: {
            arm64: win32.arm64,
...
const triples = (()=>{
    ...
    if (rawTargetTriple) {
        _log.warn(`Trying to load next-swc for target triple ${rawTargetTriple}, but this target is not supported`);
    } else {
