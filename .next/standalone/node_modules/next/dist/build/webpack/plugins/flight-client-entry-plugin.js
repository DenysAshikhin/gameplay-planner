...
const _actionencryptionutils = require("../../../server/app-render/action-encryption-utils");
...
class FlightClientEntryPlugin {
    ...
    injectActionEntry({ compiler, compilation, actions, entryName, bundlePath, fromClient }) {
        ...
        if (actionsArray.length > 0 && _semver.default.lt(process.version, "18.11.0")) {
    ...
    async createActionAssets(compilation, assets) {
        ...
        const json = JSON.stringify({
            ...
            // Assign encryption
            encryptionKey: await (0, _actionencryptionutils.generateRandomActionKeyRaw)(this.dev)
